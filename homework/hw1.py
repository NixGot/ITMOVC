...
Name.PrintMax()
plt.show()
# graph.MakePlot2(Name.max_data, 1, 0)
# graph.MakeApprox(0.1, 0.7, 0.01, [Name.max_data.T[1], Name.max_data.T[0]], 3)
# n = Name.Names()
# n.append('аппроксимация')
# graph.MakeLegend(n)
# graph.MakeLabel('Положение максимума', 'Значение функции', 'plarity and maximums') # переделать по заданию построение графика
plt.show()
